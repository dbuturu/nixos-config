...

{
  ...
  services = {
    ...
    resolved = {
      enable = true;
      extraConfig = ''
        DNS=45.90.28.0#29a6c7.dns.nextdns.io
        DNS=45.90.30.0#29a6c7.dns.nextdns.io
        DNSOverTLS=yes
      '';
    };
  ...
  nix = {
    settings = {
      trusted-users = [ "root" "dbuturu" ]; # Users who can configure Nix
      experimental-features = [ "nix-command" "flakes" ]; # Enable new Nix CLI
